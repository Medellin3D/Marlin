...
#define STRING_CONFIG_H_AUTHOR "(@jorgelserve, Genius 2)" // Who made the changes.
...
#define MACHINE_UUID "06af0770-5e7d-41ac-bd12-77b3581a0b76"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 616.092 }
